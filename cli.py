"""
Command Line Interface for Context Rollover Checkpoint Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="context-rollover-checkpoint-agent", description="Context Rollover Checkpoint Agent")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Context Rollover Checkpoint Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Context Rollover Checkpoint Agent API server on http://{args.host}:{args.port}")
